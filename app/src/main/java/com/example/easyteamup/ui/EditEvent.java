...
public class EditEvent extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        if (MainActivity.infoBundle.getBoolean("first")) {
            ...
            if (event.getStatusPublic()) {
                ...
                MainActivity.infoBundle.putString("temp_event_statuspublic", "Private");
            }
            ...
            MainActivity.infoBundle.putSerializable("temp_time_options", event.getTimeOptions());
        }
    ...
    public void savePageEntries() {
        MainActivity.infoBundle.putBoolean("first", false);
        String createdName = nameCreate.getText().toString();
        String createdStatusPublic = statusPublicSpinner.getSelectedItem().toString();
